...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "convertTime", function (secs) {
    ...
    _defineProperty(_assertThisInitialized(_this), "componentDidMount", function () {
      _this.convertTime(_this.state.seconds);
    });

    _defineProperty(_assertThisInitialized(_this), "startTimer", function () {
      var secs = Number(_this.state.h * 60 * 60) + Number(_this.state.m * 60) + Number(_this.state.s);

      _this.convertTime(secs);

      _this.setState({}); //this.setState({time:t});
      //  this.setState({timer:false});
      //  console.log('start timer',this.state.timer);


      if (!_this.state.timer && !_this.state.interval) //for not calling the 
        _this.state.interval = setInterval(_this.countDown, 1000);
    });

    _defineProperty(_assertThisInitialized(_this), "countDown", function () {
      var s = _this.state.seconds - 1;

      if (s >= 0 && !_this.state.timer) {
        _this.convertTime(s);
    ...
    _defineProperty(_assertThisInitialized(_this), "userInput", function () {
      ...
      }); //why after double submit time getting changed

    });

    _defineProperty(_assertThisInitialized(_this), "changeTimer", function () {
      _this.setState({
        timer: false,
        stopon: true,
        starton: false,
    ...
    _defineProperty(_assertThisInitialized(_this), "handelChange", function (e, type) {
      e.persist(); //wont clear the object when we close the app
      // console.log('handel change',e,type);

      if (type == 'hours') {
        var secs = Number(e.target.value * 60 * 60) + Number(_this.state.m * 60) + Number(_this.state.s);
      ...
      if (type == 'mins') {
        var _secs = Number(_this.state.h * 60 * 60) + Number(e.target.value * 60) + Number(_this.state.s);
      ...
      if (type == 'secs') {
        var _secs2 = Number(_this.state.h * 60 * 60) + Number(_this.state.m * 60) + Number(e.target.value);
    ...
    _defineProperty(_assertThisInitialized(_this), "startset", function () {
      var secs = Number(_this.state.h * 60 * 60) + Number(_this.state.m * 60) + Number(_this.state.s);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      //flex boxes
      var stop = this.state.stopon ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("button", {
        onClick: this.stopTimer
      }, "Stop")) : null;
      var start = this.state.starton ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("button", {
        onClick: this.changeTimer
      }, "Start")) : null;

      var reset = /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("button", {
        onClick: this.resetTimer
      }, "Reset"));

      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h3", null, "Countdown Timer")), /*#__PURE__*/_react.default.createElement("div", {
        className: "timelabel"
      }, /*#__PURE__*/_react.default.createElement("label", {
        htmlFor: "hour"
      }, "Hour"), /*#__PURE__*/_react.default.createElement("label", {
        htmlFor: "minute",
        className: "labelmin"
      }, "Minute"), /*#__PURE__*/_react.default.createElement("label", {
        htmlFor: "second"
      }, "Second")), /*#__PURE__*/_react.default.createElement("div", {
        className: "time"
      }, /*#__PURE__*/_react.default.createElement("input", {
        type: "number",
        onChange: function onChange(e) {
          return _this2.handelChange(e, 'hours');
        },
        min: "0",
        value: this.state.h,
        id: "hour"
      }), /*#__PURE__*/_react.default.createElement("h4", null, ":"), /*#__PURE__*/_react.default.createElement("input", {
        type: "number",
        onChange: function onChange(e) {
          return _this2.handelChange(e, 'mins');
        },
        min: "0",
        max: "60",
        value: this.state.m,
        ...
        type: "number",
        onChange: function onChange(e) {
          return _this2.handelChange(e, 'secs');
        },
        min: "0",
        max: "60",
        value: this.state.s,
...
//# sourceMappingURL=/countdowntimer.e31bb0bc.js.map